...
int native_lib_main(std::string& report, std::string filename)
{
    ...
    std::string positif = "Positif";
    std::string negatif = "Negatif";
    std::string ragu = "Kualitas Rekaman Kurang Baik";
    ...
    // report = "Dim: " + std::to_string(sing.dim) + ", Size: " + std::to_string(sing.size) + ", Dispersi: " + std::to_string(sing.dispersi)  +"\n";
    report = std::to_string(sing.dim) + "," + std::to_string(sing.size) + "," + std::to_string(sing.dispersi)  +",";
    ...
    for (n=1; n<nmax; n++)
    {
        ...
        if (imin <= howoften1)
        {
            ...
            if (MINDIST > 0)
            {
                ...
                n2=(sn+MINDIST<SAMPLE_MAX-(EMBED-1)*DELAY)?sn+MINDIST:
                   SAMPLE_MAX-(EMBED-1)*DELAY-1;
                for (i1=n1; i1<=n2; i1++)
                    if ((oscr[i1] < n))
                        lnorm--;
            }
